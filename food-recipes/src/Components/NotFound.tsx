...
const NotFound = () => {
  ...
  return (
    <Box sx={{height:"100vh" , display:"flex" ,  flexDirection:"column" ,  alignItems:"center" , justifyContent:"center"}}>
        ...
        <Typography variant="h1" sx={{fontSize:"15rem" , color:"#E53935"}}>4</Typography>
        ...
        <Box sx={{marginTop:"5rem"}}>
            <Button variant="contained" onClick={() => navigate("/home")} sx={{padding:"0.5rem 3rem" , fontWeight:"bold"}}>
                Go Home
            </Button>
        </Box>
    </Box>
